    ...
    return (
        <Fragment>
            ...
            <div className="btn-group" role="group" aria-label="Basic example">
                <button type="button" className="btn btn-primary" onClick={() => { setFormType('Sat') }}>Sắt</button>
                <button type="button" className="btn btn-primary" onClick={() => { setFormType('Linhkien') }}>Linh kiện</button>
                <button type="button" className="btn btn-primary" onClick={() => { setFormType('Tole') }}>Tole</button>
            </div>
